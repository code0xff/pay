...
| **13** | EVM x402 프로토콜 정합성 (EIP-712 도메인 on-chain 조회, typed envelope builder, decimals 테이블, 다중 accepts, 후보 선택 강화) | P1+P2 | 구현 완료 |
| **14** | x402 v1 EVM 지원 (v1 EVM envelope 포맷 조사, x402-chain-eip155 컨트리뷰션 또는 직접 구현) | P3 | 설계 완료 |
