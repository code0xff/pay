...
| 20 | [docs/implementation/20-phase20-solana-feature-gate.md](docs/implementation/20-phase20-solana-feature-gate.md) | `evm` feature 제거, `solana` feature 신설 — EVM/x402 무조건 컴파일, Solana/MPP/Session opt-in | P1 | 설계 완료 |
