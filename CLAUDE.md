...
- [x] Phase 10 (MVP): EVM 키스토어 CLI 진입점 — `pay account new --chain-family evm --network <slug> [--backend keychain|gnome-keyring|windows-hello|1password]`, `pay account destroy --network <slug>` EVM 분기 (secp256k1 keystore 항목 삭제 포함)
- [ ] Phase 10 (cont.): `pay account import --chain-family evm --secret-key-hex 0x...` — 기존 키 hex paste import 흐름
