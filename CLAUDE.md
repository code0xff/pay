...
- [ ] Phase 10: EVM 키스토어 CLI 진입점 — `pay account new --chain-family evm --keystore apple-keychain`, `pay account import --chain-family evm --secret-key-hex 0x...`, `pay account destroy` EVM 분기 추가
