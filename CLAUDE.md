...
| 13 | [docs/implementation/13-phase13-evm-protocol-polish.md](docs/implementation/13-phase13-evm-protocol-polish.md) | EIP-712 도메인 on-chain 조회, typed envelope builder, decimals 테이블, v1 명시 거절, 다중 accepts | P1+P2 | 구현 완료 |
...
| 20 | [docs/implementation/20-phase20-solana-feature-gate.md](docs/implementation/20-phase20-solana-feature-gate.md) | `evm` feature 제거, `solana` feature 신설 — Step 1, 2, 3a 완료. Step 3b+4는 Phase 21에서 처리 | P1 | 부분 완료 |
| 21 | [docs/implementation/21-phase21-x402-protocol-decoupling.md](docs/implementation/21-phase21-x402-protocol-decoupling.md) | `pay-core::x402_proto` 모듈로 wire 타입 분리 — solana_x402 의존성을 EVM 경로에서 제거 | P0 | 21-1 완료, 21-2~6 잔여 |
